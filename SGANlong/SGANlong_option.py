...
def option():
    ...
    parser.add_argument('--experiment_name', default='SGANlong',
    ...
    # code backup
    parser.add_argument('--save_codes', default=["SGANlong_dataset.py",
                                                 "SGANlong_framework.py",
                                                 "SGANlong_model.py",
                                                 "SGANlong_option.py",
                                                 "SGANlong_graph_build.py"],
