...
def option():
    ...
    parser.add_argument('--stack_datapath', default='../data/CTB_data/1')
    parser.add_argument('--encoder_path', default='../bert-base/')
    ...
    #
    # # 加载模型，确保设置了 from_tf=True
    # model = TFAutoModelForSequenceClassification.from_pretrained("--encoder_path", from_tf=True)

    parser.add_argument('--experiment_path', default='./',
                        help='experiment history path')
    parser.add_argument('--experiment_name', default='SGANbert',
    ...
    # code backup
    parser.add_argument('--save_codes', default=["SGANbert_dataset.py",
                                                 "SGANbert_framework.py",
                                                 "SGANbert_model.py",
                                                 "SGANbert_option.py",
                                                 "SGANbert_graph_build.py"],
